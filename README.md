...
- After installing the theme, navigate to `polybar/shapes_v2/scripts/weather.sh` 
- log into the openweathermap website and create an api key <a href="https://home.openweathermap.org/api_keys">here</a>
...
- Update both the location ID and API key in the weather script
- Done!
</details>
#####Spotify widget
